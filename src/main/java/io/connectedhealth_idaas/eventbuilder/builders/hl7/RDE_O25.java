...
public RXV PharmacyTreatmentInfusion1;
...
public CTI ClinicalTrialIdentification;
    ...
    public RXV getPharmacyTreatmentInfusion1() {
        return PharmacyTreatmentInfusion1;
    }

    public void setPharmacyTreatmentInfusion1(RXV pharmacyTreatmentInfusion1) {
        PharmacyTreatmentInfusion1 = pharmacyTreatmentInfusion1;
    }
    ...
    public NTE getNotesandComment6s() {
        return NotesandComment6s;
    }

    public void setNotesandComment6s(NTE notesandComment6s) {
        NotesandComment6s = notesandComment6s;
    }
